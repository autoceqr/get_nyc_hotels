...
/* Page Categorizer */
s.categorizePage = function() {

    var ret = s.products;

    if (typeof digitalData !== "undefined" && digitalData.page && digitalData.page.tags) {

        for (var i = 0; i < digitalData.page.tags.length; i++) {

            if (ret) {
                ret += ",;" + digitalData.page.tags[i].tag + ";;;;eVar49=" + digitalData.page.tags[i].category;
            } else {
                ret = ";" + digitalData.page.tags[i].tag + ";;;;eVar49=" + digitalData.page.tags[i].category;
            }
    ...
    if (obj.href) {
        ...
        if (s.trackExternalLinks == false) {
            ...
            if (isExitLink) {
                ...
                s.linkTrackVars = "products,prop6,prop33";

                // Get partner
                if (this.hostname) {
                    s.prop6 = this.hostname;
                }
...
s.linkInternalFilters = "javascript:,mailto:,tel:,nycgo.com,dev-upgrade.nycgo.com,stage-upgrade.nycgo.com";
...
function s_doPlugins(s) {
    ...
    s.eVar16 = s.getVisitNumCustom();
    s.eVar17 = s.getDaysSinceLastVisit("s_lv");
    s.prop15 = "D=v15";
    s.prop16 = "D=v16";
    s.prop17 = "D=v17";
...
/*
 * Plugin: getVisitNumCustom
 */
s.getVisitNumCustom=function(tp){var s=this,e=new Date,cval,cvisit,ct=e.getTime(),c="s_vnum_"+tp,c2="sinvisit_"+tp,eo=s.endof(tp),y=eo.getTime();e.setTime(y);cval=s.c_r(c);if(cval)var i=cval.indexOf("&vn="),str=cval.substring(i+4,cval.length),k;cvisit=s.c_r(c2);if(cvisit)if(str){e.setTime(ct+30*60*1E3);s.c_w(c2,"true",e);return str}else return"unknown visit number";else if(str){str++;k=cval.substring(0,i);e.setTime(k);s.c_w(c,k+"&vn="+str,e);e.setTime(ct+30*60*1E3);s.c_w(c2,"true",e);return str}else{s.c_w(c,
y+"&vn=1",e);e.setTime(ct+30*60*1E3);s.c_w(c2,"true",e);return 1}};
s.endof=function(x){var t=new Date;t.setHours(0);t.setMinutes(0);t.setSeconds(0);if(x=="m")d=s.dimo(t.getMonth(),t.getFullYear())-t.getDate()+1;else if(x=="w")d=7-t.getDay();else d=1;t.setDate(t.getDate()+d);return t};
s.dimo=function(m,y){var d=new Date(y,m+1,0);return d.getDate()};

/*
 * Plugin: getTimeParting v3.4
 */
s.getTimeParting=function(h,z){var s=this,od;od=new Date("1/1/2000");if(od.getDay()!=6||od.getMonth()!=0)return"Data Not Available";else{var H,M,D,U,ds,de,tm,da=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],d=new Date;z=z?z:0;z=parseFloat(z);if(s._tpDST){var dso=s._tpDST[d.getFullYear()].split(/,/);ds=new Date(dso[0]+"/"+d.getFullYear());de=new Date(dso[1]+"/"+d.getFullYear());if(h=="n"&&d>ds&&d<de)z=z+1;else if(h=="s"&&(d>de||d<ds))z=z+1}d=d.getTime()+d.getTimezoneOffset()*
6E4;d=new Date(d+36E5*z);H=d.getHours();M=d.getMinutes();M=M<10?"0"+M:M;D=d.getDay();U=" AM";if(H>=12){U=" PM";H=H-12}if(H==0)H=12;D=da[D];tm=H+":"+M+U;return tm+"|"+D}};
...
/*
 * Plugin: getDaysSinceLastVisit v2.0
 */
...
/*
 * Plugin: getQueryParam v2.5 (Minified)
 */ 
...
/* Plugin Utility: pt v1.0 (Minified) */ 
s.pt=function(x,d,f,a){var s=this,t=x,z=0,y,r;while(t){y=t.indexOf(d);y=y<0?t.length:y;t=t.substring(0,y);r=s[f](t,a);if(r)return r;z+=y+d.length;t=x.substring(z,x.length);t=z<x.length?t:""}return""};
